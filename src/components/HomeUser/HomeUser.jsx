...
import { StyledImg , StyledProductList , StyleProducts , StyleButton , StyledImgDiv , StyledTextDiv , StyledSearch , StyledInput , StyledSelect , StyledSearchIcon} from './StyledHome'
import { FaSearch } from 'react-icons/fa'
import useGetProducts from '../../hooks/useGetProducts'
const HomeUser = ({cartItems , incrementCartItems}) => {
...
const {
  ...
  selectValue , 
  setSelectValue
 } = useGetProducts("http://localhost:3000/posts" )
